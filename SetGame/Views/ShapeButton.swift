...
class ShapeButton: UIButton {
    ...
    init(shapeType: ShapeType.RawValue, shapeView: ShapeView.RawValue, shapeAmount: Int, shapeColor: ShapeColor.RawValue, clickAction: @escaping () -> Void) {
