...
#ifndef SETGAME_SWIFT_H
#define SETGAME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SetGame",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7SetGame11AppDelegate")
...
SWIFT_CLASS("_TtC7SetGame22CardCollectionViewCell")
...
@interface MainActiveView (SWIFT_EXTENSION(SetGame)) <UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC7SetGame13SceneDelegate")
...
SWIFT_CLASS("_TtC7SetGame11ShapeButton")
...
SWIFT_CLASS("_TtC7SetGame9ShapeView")
